export const title = 'Start Close In'
export const description = 'David Whyte\'s wonderful poem hauls Marcus clean out of coding hell, how poetry informs programming.'
export const created = '2020-04-30'
